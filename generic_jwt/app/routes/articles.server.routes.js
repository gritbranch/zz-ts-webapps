...
module.exports = function(app) {
  app.route('/api/articles')
     .get(articles.find)
     .post(users.authenticateJwt, articles.create);
  
  app.route('/api/articles/:articleId')
     .get(articles.read)
     .put(users.authenticateJwt, articles.update)
     .delete(users.authenticateJwt, articles.delete);
  ...
  app.param('articleId', articles.findById);
};